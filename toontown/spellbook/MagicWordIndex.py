...
class SpawnCog(MagicWord):
    ...
    execLocation = MagicWordConfig.EXEC_LOC_SERVER
    arguments = [("suit", str, True), ("level", int, False, 1), ("specialSuit", int, False, 0), ("skelecog", int, False, 0), ("revives", int, False, 0)]
    ...
    def handleWord(self, invoker, avId, toon, *args):
        ...
        sp.createNewSuit([], pointmap, suitName=name, suitLevel=level, isElite=specialSuit, skelecog=skelecog, revives=revives)
