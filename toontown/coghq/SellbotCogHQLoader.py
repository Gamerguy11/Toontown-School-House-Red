...
class SellbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def __init__(self, hood, parentFSMState, doneEvent):
        ...
        rngMusic = random.randint(1, 101)
        if rngMusic <= 33:
            self.musicFile = 'phase_12/audio/bgm/Bossbot_Entry_v2.ogg'
        elif rngMusic >= 67:
            self.musicFile = 'phase_12/audio/bgm/Bossbot_Entry_v3.ogg'
        else:
            self.musicFile = 'phase_12/audio/bgm/Bossbot_Entry_v1.ogg'
    ...
    def loadPlaceGeom(self, zoneId):
        ...
        if zoneId == ToontownGlobals.SellbotHQ:
            ...
            self.factory = loader.loadModel('phase_9/models/cogHQ/SellbotFactoryExterior')
            self.factory.reparentTo(self.geom)
            self.factory.setPos(500, -162, -42)
            self.factory.setHpr(-90, 0, 0)
