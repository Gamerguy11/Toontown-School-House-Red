...
class DistributedBossCogAI(DistributedAvatarAI.DistributedAvatarAI):
    ...
    def invokeSuitPlanner(self, buildingCode, skelecog, variedSuits,):
        planner = SuitPlannerInteriorAI.SuitPlannerInteriorAI(1, buildingCode, self.dna.dept, self.zoneId, variedSuits=variedSuits,)
