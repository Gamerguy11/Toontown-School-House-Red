...
def getRandomSuitType(level, rng = random):
    if level <= 10:
        ...
        returnval = random.randint(6, 8)
    elif level > 12 and level <= 15:
        returnval = random.randint(7, 8)
    elif level > 15:  # and level <= 17
        returnval = 8
    # elif level > 17:
    #    returnval = random.randint(8, 9)
    return returnval

def getRandomVariedSuitType(level, rng = random):
    returnval = random.randint(1, 8)
    if level < returnval:
        returnval = level
    return returnval
