...
class SuitPlannerInteriorAI:
    ...
    def __init__(self, numFloors, bldgLevel, bldgTrack, zone, respectInvasions=1, variedSuits=0):
    ...
    def __genNormalSuitType(self, lvl):
        ...
        if self.variedSuits:
            return SuitDNA.getRandomVariedSuitType(lvl)
        else:
