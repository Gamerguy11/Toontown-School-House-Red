...
AvPropDamage = ((((8, 10), (Levels[0][0], Levels[0][1])),
 ...
 (((15, 30), (Levels[1][0], Levels[1][1])),
  ((35, 56), (Levels[1][1], Levels[1][2])),
  ((72, 90), (Levels[1][2], Levels[1][3])),
  ((118, 135), (Levels[1][3], Levels[1][4])),
  ((182, 198), (Levels[1][4], Levels[1][5])),
  ((355, 365), (Levels[1][5], Levels[1][6])),
 ...
 (((4, 6), (Levels[3][0], Levels[3][1])),
  ((8, 10), (Levels[3][1], Levels[3][2])),
  ((11, 16), (Levels[3][2], Levels[3][3])),
  ((18, 21), (Levels[3][3], Levels[3][4])),
 ...
 (((4, 8), (Levels[4][0], Levels[4][1])),
  ...
  ((14, 20), (Levels[4][2], Levels[4][3])),
  ((42, 50), (Levels[4][3], Levels[4][4])),
  ((58, 90), (Levels[4][4], Levels[4][5])),
  ((95, 130), (Levels[4][5], Levels[4][6])),
  ((150, 150), (Levels[4][6], MaxSkill))),
 (((3, 4), (Levels[5][0], Levels[5][1])),
  ((6, 8), (Levels[5][1], Levels[5][2])),
  ((10, 16), (Levels[5][2], Levels[5][3])),
  ((21, 27), (Levels[5][3], Levels[5][4])),
  ((30, 56), (Levels[5][4], Levels[5][5])),
  ((58, 90), (Levels[5][5], Levels[5][6])),
  ((115, 115), (Levels[5][6], MaxSkill))),
 (((10, 15), (Levels[6][0], Levels[6][1])),
  ((18, 21), (Levels[6][1], Levels[6][2])),
  ((30, 55), (Levels[6][2], Levels[6][3])),
  ((60, 80), (Levels[6][3], Levels[6][4])),
  ((90, 125), (Levels[6][4], Levels[6][5])),
  ((185, 220), (Levels[6][5], Levels[6][6])),
